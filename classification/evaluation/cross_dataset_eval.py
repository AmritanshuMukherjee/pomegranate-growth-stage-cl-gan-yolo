...
def cross_dataset_eval(checkpoint_path: str, source_name: str):
    ...
    dataset = YOLODataset(
        Path(dataset_config["sources"][source_name]["path"]),
        "images",
        "labels",
    ...
    print(f"{source_name} mAP@0.5:", calculate_map(preds, gts))


if __name__ == "__main__":
    import sys
    cross_dataset_eval(sys.argv[1], sys.argv[2])
