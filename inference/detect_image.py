...
def detect_image(config_path: str, checkpoint_path: str, image_path: str, output_path: str):
    ...
    # Preprocess
    image_resized = cv2.resize(image_rgb, (dataset_config['image_size'], dataset_config['image_size']))
...
if __name__ == "__main__":
    ...
    detect_image(args.config, args.checkpoint, args.image, args.output)
